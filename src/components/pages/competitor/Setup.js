		...
		<div className="content">
			...
			<div className="setup_div">
				...
				<form onSubmit={formHandler} className="setup_form">
					...
					<input autoComplete="false" className="text_field short" placeholder="Full Name" name="member1" id="member1" type="text" value={member1} onChange={e => setMember1(e.target.value)} />
					<br />
					...
					<input className="text_field long" placeholder="Eg. OTHS" name="school" id="school" type="text" value={school} onChange={e => setSchool(e.target.value)}/>
					<br />
